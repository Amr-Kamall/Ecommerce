  ...
  return (
    <section className="pt-24 relative">
      {cart.length >= 1 ? (
        <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
            ...
            >
              <div className="col-span-12 lg:col-span-2 img box">
                <Image
                  ...
                  width={400}
                  height={400}
                  className="w-full lg:w-[380px] rounded-md h-[230px] object-cover"
                />
              </div>
              <div className="col-span-12 lg:col-span-10 detail w-full lg:pl-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <h6 className="text-lama font-manrope font-bold text-2xl leading-9 text-right">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-center justify-between lg:px-6 pb-6 border-b border-gray-200 max-lg:max-w-lg max-lg:mx-auto">
            ...
            <div className="flex items-center justify-between gap-5 ">
              <h6 className="font-manrope font-bold text-3xl lead-10 text-lama">
                ${calculateSumPrice()}
              </h6>
            </div>
          </div>
          <div className="max-lg:max-w-lg max-lg:mx-auto">
            ...
            <div className="w-full flex">
              <Link
                ...
                className="rounded-full py-4 px-6 bg-lama text-white font-semibold text-lg w-full text-center transition-all duration-500 hover:bg-indigo-500 "
              >
                Checkout
              </Link>
            </div>
        ...
        <h1 className="text-3xl font-semibold text-center mt-24">
          Cart Is Empty!
        </h1>
      )}
    </section>
